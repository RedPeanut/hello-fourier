function Plot(frame, config) {
  ...
  this.init = function() {
    ...
    this.drawBackground = this.config.drawBackground || function() {
  ...
  this.drawXGrid = function() {
    ...
    let topEnd = this.getTheY(this.yMax);
    let bottomEnd = this.getTheY(this.yMin);
  ...
  this.drawYGrid = function() {
    let rightEnd = this.getTheX(this.xMin);
    let leftEnd = this.getTheX(this.xMax);
